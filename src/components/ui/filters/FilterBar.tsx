...
export default function FilterBar<T extends string>({
  ...
  // 🔽 Nuevo: colapsado por defecto en móvil
  const [isMobileOpen, setIsMobileOpen] = useState(false);

  // Drawer adicional (más filtros)
      ...
      <div className={toolbar}>
        ...
        <div className="mb-2 flex items-center gap-2 md:hidden">
          <button
            ...
            aria-controls="filters-mobile-content"
            title={isMobileOpen ? 'Ocultar filtros' : 'Mostrar filtros'}
          >
            {/* icono caret */}
            <svg
          ...
          {/* acceso directo a “Más filtros” en móvil */}
          ...
          {/* Acción aplicar visible en móvil */}
          <button
            type="button"
            onClick={apply}
        ...
        {/* ===== Contenido completo: visible siempre en md+, y en móvil solo si isMobileOpen ===== */}
        <div
          id="filters-mobile-content"
